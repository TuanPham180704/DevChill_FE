...
export default function PaymentListAdmin() {
  ...
  }, [allPayments, debouncedKeyword, statusFilter, page]);
        ...
        <div className="p-6 space-y-5 flex-1 max-w-325 mx-auto w-full">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-[14px] text-slate-500 font-medium">
              Kiểm tra, đối soát và xác nhận giao dịch thủ công 💳
            </p>
          </div>
            ...
            <div className="flex items-center gap-3 flex-wrap pl-1">
              <div className="relative w-64">
                ...
                <input
                  ...
                  placeholder="Nhập mã giao dịch hoặc username..."
                  onKeyDown={(e) => {
                ...
                {loading ? (
                  ...
                  payments.map((p) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5 font-semibold text-slate-600 text-[13px]">
                        {p.plan_name || "---"}
                      </td>
                      <td className="px-4 py-3.5 text-center font-bold text-blue-600 text-[13px]">
                        {formatCurrency(p.amount)}
                      </td>
                      <td className="px-4 py-3.5 text-center font-medium text-slate-500 text-[12.5px]">
