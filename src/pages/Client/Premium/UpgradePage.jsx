      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <span className="text-sm font-black tracking-widest" style={{ color: '#D97706' }}>
              PREMIUM PLANS
            </span>
          </div>
          ...
          <h1 
            ...
            style={{ backgroundImage: 'linear-gradient(135deg, #0F172A 0%, #475569 100%)' }}
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {FEATURES.map(({ icon: Icon, label, desc }) => (
            ...
            >
              ...
              <p className="font-bold text-sm mb-1" style={{ color: '#0F172A' }}>{label}</p>
