...
import { EyeOff, Film, Mail, Lock, User } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="rounded-3xl p-8" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', backdropFilter: 'blur(16px)' }}>
              <h2 className="text-3xl font-black text-white mb-1">Tạo tài khoản</h2>
              <p className="text-sm mb-7" style={{ color: '#64748B' }}>Tham gia cộng đồng DevChill ngay hôm nay!</p>
              <div className="space-y-4">
                <div>
                  <label className="text-xs font-semibold mb-1.5 block tracking-wider" style={{ color: '#64748B' }}>HỌ VÀ TÊN</label>
                  <div className="relative">
                    <User size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2" style={{ color: '#475569' }} />
                    <input className={`${inputBase} pl-10`} style={inputNormal} placeholder="Nguyễn Văn A" type="text" />
                  </div>
                </div>
                <div>
                ...
                <div>
                  <label className="text-xs font-semibold mb-1.5 block tracking-wider" style={{ color: '#64748B' }}>MẬT KHẨU</label>
                  <div className="relative">
                    <Lock size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2" style={{ color: '#475569' }} />
                    <input className={`${inputBase} pl-10 pr-10`} style={inputNormal} placeholder="••••••••" type="password" />
                ...
                <div>
                  <label className="text-xs font-semibold mb-1.5 block tracking-wider" style={{ color: '#64748B' }}>XÁC NHẬN MẬT KHẨU</label>
                  <div className="relative">
                    <Lock size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2" style={{ color: '#475569' }} />
                    <input className={`${inputBase} pl-10 pr-10`} style={inputNormal} placeholder="••••••••" type="password" />
                    <button type="button" className="absolute right-3.5 top-1/2 -translate-y-1/2" style={{ color: '#64748B' }}>
                ...
                <button type="button" className={gradBtn} style={gradStyle}>Đăng ký ngay</button>
              </div>
              <p className="text-center mt-6 text-sm" style={{ color: '#64748B' }}>
                Đã có tài khoản? <Link to="/logintest" className="font-semibold hover:underline" style={{ color: '#00D4FF' }}>Đăng nhập</Link>
              </p>
          </div>
