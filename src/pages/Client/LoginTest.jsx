...
import { EyeOff, Film, Mail, Lock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#0D0D0D' }}>
      <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden flex-col">
        ...
        <div className="absolute bottom-8 right-8 text-6xl font-black select-none opacity-[0.04] tracking-[0.3em]" style={{ color: '#00D4FF' }}></div>
        <div className="relative z-10 flex flex-col justify-center h-full px-14 py-16">
          <Link 
            to="/" 
            className="flex items-center gap-3 mb-12 w-fit cursor-pointer hover:opacity-80 transition-all duration-200"
          >
            {/* Icon container */}
            <div 
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="rounded-3xl p-8" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', backdropFilter: 'blur(16px)' }}>
            ...
            <p className="text-sm mb-7" style={{ color: '#64748B' }}>Chào mừng trở lại với DevChill!</p>
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex justify-end mt-1.5">
                  <Link to="/forgottest" className="text-xs hover:underline" style={{ color: '#00D4FF' }}>Quên mật khẩu?</Link>
                </div>
              </div>
              <button type="button" className={gradBtn} style={gradStyle}>Đăng nhập</button>
            </div>
            <p className="text-center mt-6 text-sm" style={{ color: '#64748B' }}>
              Chưa có tài khoản? <Link to="/registertest" className="font-semibold hover:underline" style={{ color: '#00D4FF' }}>Đăng ký ngay</Link>
            </p>
          </div>
